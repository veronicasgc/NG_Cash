...
//     jest.spyOn(UserDatabase.prototype, "findUsername").mockResolvedValue(undefined)
//     jest.spyOn(UserDatabase.prototype, "signup").mockResolvedValue(undefined)
//     jest.spyOn(AccountDatabase.prototype, "createAccount").mockResolvedValue(undefined)
//   });
//    afterEach(()=>{
...
// describe("UserBusiness - register user",()=>{
//   beforeEach(()=>{
//     jest.spyOn(HashManager.prototype, "hash").mockResolvedValue("hash-fake")
//     jest.spyOn(IdGenerator.prototype, "generateId").mockReturnValue(123456)
//     jest.spyOn(Authenticator.prototype, "generateToken").mockReturnValue("token-fake")
...
//     jest.restoreAllMocks()
//   })
//   test("Should retunr all users", async ()=>{
//     const userBusiness = new UserBusiness()
